...
def plot_subplot1(ax, file_path):
    ...
    # choose channel 1 for current plot 
    ...
    signal = data['CH1 Volt'].values  # assign "Ch1" col to be signal data 
    ...
    ax.set_yticks([])  
    #ax.set_title('CSV SDS00023_Current') # sets the title of the plot, i made it the csv num 
